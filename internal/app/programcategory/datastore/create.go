...
func (impl ProgramCategoryStorerImpl) Create(ctx context.Context, u *ProgramCategory) error {
	// DEVELOPER NOTES:
...
func (impl ProgramCategoryStorerImpl) generatePublicID(ctx context.Context, tenantID primitive.ObjectID) (uint64, error) {
	var publicID uint64
