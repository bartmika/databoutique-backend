...
func (h *Handler) ListAsSelectOptionByFilter(w http.ResponseWriter, r *http.Request) {
	...
	f := &programcategory_s.ProgramCategoryPaginationListFilter{
		PageSize: 1_000_000,
		// LastID:    "",
		SortField: "sort_number",
		SortOrder: 1, // 1=ascending | -1=descending
		Status:    programcategory_s.ProgramCategoryStatusActive,
	}
...
func MarshalListAsSelectOptionResponse(res []*programcategory_s.ProgramCategoryAsSelectOption, w http.ResponseWriter) {
