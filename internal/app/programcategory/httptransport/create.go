...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*programcategory_c.ProgramCategoryCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData programcategory_c.ProgramCategoryCreateRequestIDO
...
func MarshalCreateResponse(res *programcategory_s.ProgramCategory, w http.ResponseWriter) {
