...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*program_c.ProgramCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData program_c.ProgramCreateRequestIDO
...
func MarshalCreateResponse(res *program_s.Program, w http.ResponseWriter) {
