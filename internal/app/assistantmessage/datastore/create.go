...
func (impl AssistantMessageStorerImpl) Create(ctx context.Context, u *AssistantMessage) error {
	// DEVELOPER NOTES:
...
func (impl AssistantMessageStorerImpl) generatePublicID(ctx context.Context, tenantID primitive.ObjectID) (uint64, error) {
	var publicID uint64
