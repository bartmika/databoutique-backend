...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*assistantmessage_c.AssistantMessageCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData assistantmessage_c.AssistantMessageCreateRequestIDO
...
func MarshalCreateResponse(res *assistantmessage_s.AssistantMessage, w http.ResponseWriter) {
