...
func (impl AssistantFileStorerImpl) Create(ctx context.Context, u *AssistantFile) error {
	// DEVELOPER NOTES:
	...
	if u.ID == primitive.NilObjectID {
		...
		impl.Logger.Warn("database insert assistantfile not included id value, created id now.", slog.Any("id", u.ID))
	}
