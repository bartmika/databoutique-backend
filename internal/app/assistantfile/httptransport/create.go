...
import (
	...
	a_s "github.com/bartmika/databoutique-backend/internal/app/assistantfile/datastore"
	"github.com/bartmika/databoutique-backend/internal/utils/httperror"
)

func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*a_c.AssistantFileCreateRequestIDO, error) {
	defer r.Body.Close()
	...
	requestData := &a_c.AssistantFileCreateRequestIDO{
		Name:        name,
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	assistantfile, err := h.Controller.Create(ctx, data)
	if err != nil {
		httperror.ResponseError(w, err)
		return
	}

	MarshalCreateResponse(assistantfile, w)
}

func MarshalCreateResponse(res *a_s.AssistantFile, w http.ResponseWriter) {
