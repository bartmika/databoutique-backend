...
func (impl ExecutableStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *ExecutablePaginationListFilter) ([]*ExecutableAsSelectOption, error) {
	...
	var results = []*ExecutableAsSelectOption{}
